...
class CopanBehaveModel(object):
	...
	def update_contact_network(self, contact_network, proximity_matrix,
	    ...
	    #  Exclusively consider bidirectional contact preferences
	    #contact_adjacency = contact_adjacency * contact_adjacency.transpose()

	    #  Inclusively consider all bi- and unidirectional contact preferences
	    #contact_adjacency = (contact_adjacency + contact_adjacency.transpose() > 0).astype("int8")
