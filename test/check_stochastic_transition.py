...
def transient_disposition_distribution(N,disp_distr_t,yb,kolm_smir):
	...
	while kolm_smir_step >= target:
		...
		# add the noise
		disp_distr_tp1=disp_distr_t+tr_noise_coeff_start*random_sign*random_noise_increase*distr_dev
...
for i in xrange(1,n_transition):
	...
	print 'yb',yb,i						
	char_dist[:,i],kolm_smir_trans,improvement_random_process=transient_disposition_distribution(N,char_dist[:,i-1],yb,kolm_smir_trans)
